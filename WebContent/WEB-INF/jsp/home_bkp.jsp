...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/LoginCheck.js"></script>
<style>
...
<body ng-controller="loginCheck">
	<table bgcolor="#F1F6FA" height=100% width=100%>
		...
		<tr>
			<td width="600"><br>
				<form name="login" action="/CarPool/loginValidation" onsubmit="return loginCheck()" method="post">
					<p class="firstclass">
						&nbsp;&nbsp;&nbsp; User ID &nbsp; :&nbsp;&nbsp; 
				...
				<td><img src="<%=request.getContextPath()%>/resources/images/sharing-is-caring-17.jpg"
					...
					<table height=100% width=100% ><tr><td><form action="aboutUs" align="right"><input type="submit" value="About US" width=50%/></form></td>
					<td><form action="contactUs" align="right"><input type="submit" value="Contact Us"/></form></td></tr></table>
				</td>
		</tr>
	</table>
</body>
