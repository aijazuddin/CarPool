...
<body bgcolor="#F1F6FA">
	...
	<table align="center">
		<tr>
			<td>
				<p class="resultheading">New Post as Driver</p>
			</td>
			<td>
	...
	<form name="postAsDriverSubmit" action="postAsDriverSubmit" method="post">
		...
		<table align="center">
			...
			<tr>
				<td><input type="submit" name="Post" value="Post Ride"
					style="width: 100%" /></td>
			</tr>
		</table>
	</form>
	...
	<form action="">
		<table border="1" align="center">
			<tr>
				<td>Passengers Applied/Approved</td>
			</tr>
			<tr>
				<td>
					<table>
